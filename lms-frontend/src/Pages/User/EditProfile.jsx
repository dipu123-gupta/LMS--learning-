    ...
    <HomeLayout>
      <div className="flex items-center justify-center min-h-[90vh] px-4 bg-gradient-to-br from-[#0F172A] to-[#020617]">
        <form
          ...
          "
        >
          <h1 className="text-center text-xl sm:text-2xl font-bold text-yellow-400">
            Edit Profile
          </h1>
          ...
          <label htmlFor="image_uploads" className="cursor-pointer">
            {data.previewImage ? (
              ...
              <BsPersonCircle className="w-24 h-24 sm:w-28 sm:h-28 mx-auto text-gray-400" />
            )}
          </label>
          ...
          <div className="flex flex-col gap-2">
            <label className="font-semibold text-sm sm:text-base text-gray-300">
              Full Name
            </label>
            <input
              type="text"
              ...
              className="
                bg-transparent border border-gray-600 rounded-md
                px-3 py-2
          ...
          <Link
            to="/user/profile"
            className="flex items-center justify-center gap-2 text-xs sm:text-sm text-yellow-400 hover:underline"
          >
            <AiOutlineArrowLeft />
            Go back to profile
          </Link>
