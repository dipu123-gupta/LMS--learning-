...
//     if (window.confirm("Are you sure you want to delete the course ?")) {
//       const res = await dispatch(deleteCourses(id));
//       if (res?.payload) dispatch(getAllCourses());
//     }
//   };
...
//   return (
//     <HomeLayout>
//       <div className="min-h-[90vh] pt-6 px-4 sm:px-6 lg:px-10 flex flex-col gap-8 sm:gap-10 text-white">

//         <h1 className="text-center text-3xl sm:text-4xl lg:text-5xl mt-12 font-semibold text-yellow-500">
//           Admin Dashboard
//         </h1>
...
//             <button
//               onClick={() => navigate("/course/create")}
//               className="bg-yellow-500 px-4 py-2 rounded font-semibold text-black"
//             >
//               Create New Course
//             </button>
//           </div>
