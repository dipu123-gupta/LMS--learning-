  ...
  return (
    <HomeLayout>
      <div className="min-h-[90vh] flex items-center justify-center bg-gradient-to-br from-[#020617] via-[#0f172a] to-[#020617] text-white px-4">
        ...
        {/* 👇 FORM (top se 30px margin yahin add kiya hai) */}
        <form
          onSubmit={handleSubmit}
          className="w-full max-w-md mt-[50px] mb-[50px] bg-white/10 backdrop-blur-xl border border-white/10 rounded-2xl shadow-[0_20px_50px_rgba(0,0,0,0.7)] p-8 space-y-5"
        >
          {/* TITLE */}
