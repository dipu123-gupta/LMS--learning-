...
const CreateCourse = () => {
  ...
  return (
    <HomeLayout>
      <div className="flex items-center justify-center min-h-[90vh] px-4 py-6">
        <form
          onSubmit={onFormSubmit}
          className=" mt-12 relative w-full max-w-5xl rounded-2xl bg-gradient-to-br from-[#1f2937] to-[#111827] p-5 sm:p-6 lg:p-8 shadow-2xl border border-gray-700 text-white
          "
        >
          {/* Back button */}
          <Link
            to="/courses"
            className="absolute top-4 sm:top-6 left-4 sm:left-6 text-xl sm:text-2xl text-yellow-400 hover:scale-110 transition"
          >
            <AiOutlineArrowLeft />
          </Link>
          ...
          <p className="text-center text-gray-400 text-xs sm:text-sm mt-1 mb-6 sm:mb-8">
            Fill in the details to publish a new course
          </p>
          ...
          >
            ...
            <div className="flex flex-col gap-5">
              <div className="rounded-xl border-2 border-dashed border-gray-600 hover:border-yellow-500 transition">
                <label htmlFor="image_upload" className="cursor-pointer">
                  {userInput.previewImage ? (
                    <img
                      src={userInput.previewImage}
                    ...
                    <div className="h-44 sm:h-48 flex flex-col items-center justify-center text-sm text-gray-300">
                      <span>Upload course thumbnail</span>
                    </div>
                  )}
                </label>
